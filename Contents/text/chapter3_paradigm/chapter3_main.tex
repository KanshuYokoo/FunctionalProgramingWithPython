...
\lstinputlisting[language=Python, caption=Python: Pure function]{../code/python/chapter3/pure_add.py}

An \textbf{impure function}---it reads from and modifies the external world:
\lstinputlisting[language=Python, caption=Python: Impure function]{../code/python/chapter3/impure_add.py}
...
\lstinputlisting[language=Python, caption=Python: Referential transparency example 1]{../code/python/chapter3/ref_transparency_1.py}

Because \texttt{add} is a pure function that always returns 5 for inputs \texttt{(2, 3)}, we can freely substitute:
\lstinputlisting[language=Python, caption=Python: Referential transparency example 2]{../code/python/chapter3/ref_transparency_2.py}
